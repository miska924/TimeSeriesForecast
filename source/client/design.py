...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.estimators_wrapper)
        ...
        self.horizontalLayout_10.addWidget(self.spinBox_estimators)
        ...
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.metric_wrapper)
        ...
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.comboBox_metric_wrapper)
        ...
        self.verticalLayout_8.addWidget(self.comboBox_metric)
        self.verticalLayout_7.addWidget(self.comboBox_metric_wrapper)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_upload.setText(_translate("MainWindow", "Загрузить .csv ряд с компьютера"))
        self.lineEdit_series.setPlaceholderText(_translate("MainWindow", "TICKER"))
        self.label_upload.setText(_translate("MainWindow", "Загрузите ряд"))
        self.pushButton_upload.setText(_translate("MainWindow", "Обзор..."))
        ...
        self.label_5.setText(_translate("MainWindow", "Деревьев в лесу"))
        self.label_6.setText(_translate("MainWindow", "Метрика"))
        self.label_15.setText(_translate("MainWindow", "Мин. % исходов в 1 листе"))
        self.label_16.setText(_translate("MainWindow", "% исходов для обучения"))
        self.label_10.setText(_translate("MainWindow", "Периодичность"))
        self.checkBox_cv.setText(_translate("MainWindow", "Кросс-валидация"))
        self.label_11.setText(_translate("MainWindow", "Ширина окна"))
        self.label_13.setText(_translate("MainWindow", "Сдвиг окна"))
        self.label_14.setText(_translate("MainWindow", "Размер тест. выборки"))
