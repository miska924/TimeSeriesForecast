...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_trend = QtWidgets.QComboBox(self.ets_wrapper)
        self.comboBox_trend.setObjectName("comboBox_trend")
        self.verticalLayout_16.addWidget(self.comboBox_trend)
        self.checkBox_dumped = QtWidgets.QCheckBox(self.ets_wrapper)
        self.checkBox_dumped.setObjectName("checkBox_dumped")
        self.verticalLayout_16.addWidget(self.checkBox_dumped)
